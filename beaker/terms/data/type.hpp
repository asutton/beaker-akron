...
#ifndef BEAKER_TERMS_DATA_TYPE_HPP
#define BEAKER_TERMS_DATA_TYPE_HPP
...
bool equivalent_type(const type&, const type&);
void append_type(hasher&, const type&);

void print_type(std::ostream&, const type&);
